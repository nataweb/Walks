...
namespace Walks.API.Controllers
{
    ...
    public class RegionsController : Controller
    {
        ...
        public async Task<IActionResult> 
            UpdateRegionAsync([FromRoute] Guid id,
        ...
        private bool ValidateAddRegionAsync(
            Models.DTO.AddRegionRequest addRegionRequest) 
        { 
        ...
        private bool ValidateUpdateRegionAsync(
            Models.DTO.UpdateRegionRequest updateRegionRequest) 
        {
